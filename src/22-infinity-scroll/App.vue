...
<script setup>
import LeftBar from "@/22-infinity-scroll/components/LeftBar.vue"
import Footer from "@/22-infinity-scroll/components/Footer.vue"
import UsersList from "@/22-infinity-scroll/components/UsersList.vue";
import TextBox from "@/22-infinity-scroll/components/TextBox.vue";
import Modal from "@/22-infinity-scroll/components/Modal.vue";
