<template>
    <div class="table-view">
        <table class="table">
            ...
            <tr v-if="isLoading">
                <td class="table__body-cell" colspan="6">
...
<script setup>
import Pagination from '@/21-pagination/components/Pagination.vue'
import Button from '@/21-pagination/components/Button.vue'
import TableBodyCell from "@/21-pagination/components/TableBodyCell.vue";
